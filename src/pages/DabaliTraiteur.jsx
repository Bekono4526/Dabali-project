...
function DabaliTraiteur() {
    return (
        <main className="bg-gray-100 mt-20">
            ...
            <section className="flex flex-col md:flex-row items-stretch justify-between p-6 md:p-10 bg-white shadow-md">
                ...
                <div className="w-full md:w-1/2 bg-gray-100 p-6 flex flex-col justify-center mt-4 md:mt-0">
                    <h2 className="text-2xl md:text-3xl font-bold mb-4 text-center md:text-left">DABALI XPRESS TRAITEUR</h2>
            ...
            {/* Section 2: Videos */}
            <section className="p-6 md:p-10 bg-gray-200">
                <h2 className="text-2xl md:text-3xl font-bold text-center mb-8">Nos Services en Vidéo</h2>
            ...
            <section className="p-6 md:p-10 bg-white">
                <h2 className="text-2xl md:text-3xl font-bold text-center mb-8">Articles Récents</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div className="bg-gray-100 p-6 rounded-lg shadow-md">
                        <h3 className="text-lg md:text-xl font-semibold mb-4">Titre de l'Article 1</h3>
                        <p className="text-gray-700">Résumé de l'article 1...</p>
                    </div>
                    <div className="bg-gray-100 p-6 rounded-lg shadow-md">
                        <h3 className="text-lg md:text-xl font-semibold mb-4">Titre de l'Article 2</h3>
                        <p className="text-gray-700">Résumé de l'article 2...</p>
                    </div>
                    <div className="bg-gray-100 p-6 rounded-lg shadow-md">
                        <h3 className="text-lg md:text-xl font-semibold mb-4">Titre de l'Article 3</h3>
