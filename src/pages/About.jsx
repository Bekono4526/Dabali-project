                    ...
                    <p className="text-base md:text-lg text-gray-700">
                        {showFullText ? (
                            <>
                                ...
                                <button onClick={toggleText} className="text-blue-500 hover:underline ml-2">Read Less</button>
                            </>
                        ) : (
                            <>
                                ...
                                <button onClick={toggleText} className="text-blue-500 hover:underline ml-2">Read More</button>
                            </>
                        )}
                    </p>
                </div>
            ...
            <section className="p-6 md:p-10 bg-yellow-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        <h3 className="text-xl md:text-2xl font-semibold mb-4">Valeur 1</h3>
                        <p className="text-base md:text-lg text-gray-700">
                            [Description de la valeur 1]
                        </p>
                    </div>
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        <h3 className="text-xl md:text-2xl font-semibold mb-4">Valeur 2</h3>
                        <p className="text-base md:text-lg text-gray-700">
                            [Description de la valeur 2]
                        </p>
                    </div>
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        <h3 className="text-xl md:text-2xl font-semibold mb-4">Valeur 3</h3>
                        <p className="text-base md:text-lg text-gray-700">
                            [Description de la valeur 3]
                        </p>
                    </div>
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        <h3 className="text-xl md:text-2xl font-semibold mb-4">Valeur 4</h3>
                        <p className="text-base md:text-lg text-gray-700">
