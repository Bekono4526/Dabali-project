    ...
    const menuItems = [
        ...
        },
        {
            ...
            items: [
                ...
                { name: 'Sauce Graine viande de boeuf', price: 3500, image: 'image-url-6' },
                // Add more items with images
            ],
        },
        {
                ...
                <div className="flex h-full">
                    ...
                    <div className="w-1/2 bg-white p-8 rounded-lg shadow-md flex flex-col items-center justify-center">
                        {selectedLocation ? (
                            ...
                            <p className="text-lg text-gray-700">Sélectionnez un restaurant pour voir la carte et le menu.</p>
                        )}
                    </div>
                </div>
            </div>
                                ...
                                <div className="relative">
                                    ...
                                    >
                                        {category.items.map((item, idx) => (
                                            <div key={idx} className="min-w-full sm:min-w-80 flex-shrink-0 border rounded-md p-4 shadow-sm">
                                                <img
                                                    src={item.image}
                                                    alt={item.name}
                                                ...
                                                <p className="text-gray-700">{item.price === 'Indisponible' ? item.price : `${item.price} FCFA`}</p>
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
        <div className="bg-white p-6 rounded-lg shadow-lg w-11/12 md:w-3/4 lg:w-2/3 max-h-screen overflow-y-auto">
            ...
            <ul className="mb-6 border-t border-gray-300 py-4">
                {cart.length === 0 ? (
                    <li className="text-center text-gray-500">Votre panier est vide</li>
                ) : (
                    cart.map((item, index) => (
            ...
            <div className="border-t border-gray-300 py-4 flex justify-between items-center">
                <span className="text-2xl font-bold">Total: {getTotal()} FCFA</span>
                <button
